...
interface ConditionBIntroProps {
  onStart: () => void;
}

export const ConditionBIntro: React.FC<ConditionBIntroProps> = ({ onStart }) => {
  return (
    <motion.div
      ...
      <div className="max-w-2xl w-full bg-white rounded-[3rem] shadow-2xl border border-slate-100 p-12 overflow-hidden relative">
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-4xl font-black text-slate-900 mb-6 tracking-tight">
            Condition B: <br />
            <span className="text-indigo-600">Conversational Loan Analysis</span>
          </h2>

          <p className="text-slate-500 text-lg mb-10 leading-relaxed">
            In this condition, you will analyze 3 rejected loan applications through
            <strong> conversation with an AI assistant</strong>. Each applicant's case is unique.
            Explore, question, and discover what led to each rejection.
          </p>
          ...
          <div className="space-y-6 mb-12">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-bold text-slate-900 mb-1">Chat Freely</h4>
                <p className="text-sm text-slate-500 leading-relaxed">
                  Chat with the AI about each rejected application. Ask about specific features, risk factors, or counterfactuals.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 leading-relaxed">
                  You will review three different applicants. Try asking different questions to better understand each case.
                </p>
              </div>
            </div>
          </div>
